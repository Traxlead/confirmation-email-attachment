 ...
 * 2017 Traxlead
 *
 * Changements opérés de la ligne 671 à la ligne 688
 *
 *  @author    Traxlead <alban.gonzalez@traxlead.com>
 *  @copyright 2017 Traxlead
				...
				if (!$order_creation_failed && isset($order->id))
				{
					...
					if ($id_order_state != Configuration::get('PS_OS_ERROR') && $id_order_state != Configuration::get('PS_OS_CANCELED') && $this->context->customer->id)
					{
						...
						if ((int)Configuration::get('PS_INVOICE') && $order_status->invoice && $order->invoice_number)
						{
							...
							// CEA Module Changes
							// Changed $file_attachement to $file_attachement['invoice']
							// [CHANGES BEGIN]
							...
							// CEA Module Changes
							// Added this portion of code to support the attachment
							// [CHANGES BEGIN]
							if ( (Configuration::get('CEA_ENABLED') == 1) AND (Configuration::get('CEA_ATTACHMENT_FILE') != '' ) AND is_file(Configuration::get('CEA_ATTACHMENT_FILE')) )
							{
								$file_attachement['cea']['content'] = file_get_contents(Configuration::get('CEA_ATTACHMENT_FILE'));
								$file_attachement['cea']['name'] = basename(Configuration::get('CEA_ATTACHMENT_FILE'));
								$file_attachement['cea']['mime'] = 'application/pdf';
							}
							// [CHANGES END]
						}
						else
